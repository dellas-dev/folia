...
export const marketingCopy = {
  en: {
    ...
    pricing: {
      ...
      pageTitle: 'No free tier. Clean usage from day one.',
      pageBody: 'Choose IDR for Indonesia checkout or USD for international checkout. Paid plans keep usage cleaner and more reliable for serious sellers.',
      buyLabel: 'Sign in to buy',
      idrLabel: 'Checkout with Mayar',
      usdLabel: 'Checkout with Polar',
      billingLabel: 'Need to manage an existing plan?',
      billingLink: 'Open billing settings',
      ...
      table: {
        ...
        rows: [
          ...
          ['Variations per run', '1', 'Up to 4', 'Up to 8'],
    ...
    community: {
      ...
      pageTitle: 'Browse public Folia creations.',
      pageBody: 'Visitors can explore public styles here while `/gallery` stays protected for personal history and private work.',
      ...
      emptyBody: 'Generated artwork appears here as soon as users opt in from their personal gallery.',
      ctaTitle: 'Create your own commercial-ready artwork.',
      ctaBody: 'Start with clipart elements, then move into invitation mockups as your catalog grows.',
  ...
  id: {
    ...
    pricing: {
      ...
      pageTitle: 'Tanpa paket gratis. Pemakaian lebih bersih sejak hari pertama.',
      pageBody: 'Pilih IDR untuk checkout Indonesia atau USD untuk checkout internasional. Paket berbayar menjaga penggunaan tetap lebih rapi dan stabil untuk seller serius.',
      buyLabel: 'Masuk untuk membeli',
      idrLabel: 'Checkout dengan Mayar',
      usdLabel: 'Checkout dengan Polar',
      billingLabel: 'Perlu mengelola paket yang sudah aktif?',
      billingLink: 'Buka pengaturan billing',
      ...
      table: {
        ...
        business: 'Business',
        rows: [
          ['Generator Elemen', 'Ya', 'Ya', 'Ya'],
          ['Generator Mockup', 'Tidak', 'Ya', 'Ya'],
          ['Upload gambar referensi', 'Tidak', 'Ya', 'Ya'],
          ['Resolusi output', '1024px', '2048px', '2048px'],
          ['Variasi per run', '1', 'Sampai 4', 'Sampai 8'],
          ['Akses affiliate', 'Tidak', 'Ya', 'Ya'],
        ],
      },
      cards: {
    ...
    community: {
      ...
      pageTitle: 'Jelajahi karya publik Folia.',
      pageBody: 'Pengunjung bisa melihat style publik di sini sementara `/gallery` tetap terlindungi untuk riwayat pribadi dan karya private.',
      ...
      emptyTitle: 'Belum ada karya publik.',
      emptyBody: 'Artwork akan muncul di sini setelah user memilih untuk mempublikasikannya dari galeri pribadi mereka.',
      ctaTitle: 'Buat artwork siap jual versi Anda sendiri.',
      ctaBody: 'Mulai dari clipart elemen, lalu lanjut ke mockup undangan saat katalog Anda berkembang.',
